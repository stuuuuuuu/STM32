...
const  u16 pl[]= {5000,4878,4762,4651,4545,4444,4347,4255,4167,4082,
                  ...
                  1538	,1527	,1515	,1504	,1493	,1481	,1471	,1460	,1449	,1439	,1429
                 };	//65	-70
...
void send()
{
    ...
    sprintf (str,"HZ:%3.1f_Duty:%d%%_BPM:%d_IBI:%dms_",Speak_hz,Get_Cuty(),rt_BPM(),rt_IBI());
    ESP8266_SendString ( ENABLE, str, 30, Single_ID_2 );
...
{
    sprintf(text,"频率为\"%6.1f\"赫兹",Speak_hz);
    TTSPlay('0',text);
}
...
void CCR_switch(const u16 *crr)
{
    ...
    case 1:
        ...
        break;       //TIM_SetCompare1(TIM3,*crr);TIM_SetCompare2(TIM3,*crr);TIM_SetCompare4(TIM3,*crr);
    case 2:
        TIM_SetCompare2(TIM3,*crr);
        break;
    case 3:
        TIM_SetCompare4(TIM3,*crr);
        break;
    }
}
